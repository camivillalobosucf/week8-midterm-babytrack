...
function FeedingPage() {
  ...
  async function handleDelete(id) {
    if (window.confirm('Delete this feeding entry?')) await remove(id)
  }
  ...
  return (
    <div className="tracker-page">
      ...
      {!loading && entries.length === 0 && (
        <p className="empty-text">No feedings logged yet. Tap + Add to get started.</p>
      )}
      ...
      <Modal
        ...
        title={editingEntry ? 'Edit Feeding' : 'Log Feeding'}
      >
        <FeedingForm
